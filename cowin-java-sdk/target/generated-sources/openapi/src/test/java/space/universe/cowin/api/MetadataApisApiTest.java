...
/**
 * API tests for MetadataApisApi
 */
@Ignore
public class MetadataApisApiTest {

    private final MetadataApisApi api = new MetadataApisApi();
    ...
    public void districtsTest() throws ApiException {
        ...
        InlineResponse2003 response = api.districts(stateId, acceptLanguage);
     ...
     */
    @Test
    public void statesTest() throws ApiException {
        String acceptLanguage = null;
        InlineResponse2002 response = api.states(acceptLanguage);
