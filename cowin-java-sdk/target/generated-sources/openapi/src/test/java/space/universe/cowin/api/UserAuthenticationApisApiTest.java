...
/**
 * API tests for UserAuthenticationApisApi
 */
@Ignore
public class UserAuthenticationApisApiTest {

    private final UserAuthenticationApisApi api = new UserAuthenticationApisApi();
     ...
     */
    @Test
    public void confirmOTPTest() throws ApiException {
        InlineObject1 inlineObject1 = null;
        InlineResponse2001 response = api.confirmOTP(inlineObject1);
    ...
    public void generateOTPTest() throws ApiException {
        ...
        InlineResponse200 response = api.generateOTP(inlineObject);
